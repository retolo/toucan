...
import { getOauthUrl } from '@/app/lib/Apis/clientApis';
function SignIn(){
                ...
                <Formik initialValues={initialValues} validationSchema={formSchema} onSubmit={handleLoginUser}>
                    {({values, setFieldValue}) =>(
                        ...
                        <ul className={css.scoialList}>
                            <li>
                                <svg onClick={() => handleGoogleLogin()} xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className={css.googleIcon} viewBox="0 0 16 16">
