...
import useThemeData from "@/app/lib/store/themeStore";
...
function AuthNav(){
    ...
    const {setThemeDark, setThemeLight,dark, light} = useThemeData();
    ...
    const handleDarkTheme = () =>{
        setThemeDark()
        console.log(`Dark: ${dark}`, `Light: ${light}`)
    ...
    return(
        <>
            {isAuthenticated
                ? <ul id="main" className={css.listNav}>
                    {light === true
